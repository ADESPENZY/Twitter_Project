    ...
    <div className="properties mt-10 mb-10 w-[80%] mx-auto">
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center">
          <div className="md:border-2 border-1 w-[70%] md:w-1/3"></div>
            <div className="w-10 h-10 rounded-full border-1 md:border-2 flex items-center justify-center">
      ...
      <div className="flex flex-col md:flex-row items-center gap-5 w-full">
        {FeaturedJson.map((property) => {
          ...
          return (
            <div key={property.id} className="bg-white p-4 rounded-2xl flex-1 transition-transform duration-300 hover:-translate-y-2 shadow-md shadow-green-800">
              ...
              <div className="mt-4">
                ...
                <p className="md:text-xl text-green-800 font-bold">{property.price}</p>
